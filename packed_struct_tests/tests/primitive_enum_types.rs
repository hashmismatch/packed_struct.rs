...
#[repr(u32)]
#[derive(PrimitiveEnum_u32, PartialEq, Debug, Clone, Copy)]
pub enum EnumU32 {
    VariantMin = 0,
...
#[derive(PrimitiveEnum_u64, PartialEq, Debug, Clone, Copy)]
pub enum EnumU64 {
    VariantMin = 0,
    VariantMax = 1844674407370955165
}

#[derive(PrimitiveEnum_i8, PartialEq, Debug, Clone, Copy)]
pub enum EnumI8 {
    VariantMin = -128,
    VariantMax = 127
}

#[derive(PrimitiveEnum_i16, PartialEq, Debug, Clone, Copy)]
pub enum EnumI16 {
    VariantMin = -32768,
    VariantMax = 32767
}

#[derive(PrimitiveEnum_i32, PartialEq, Debug, Clone, Copy)]
pub enum EnumI32 {
...
#[cfg(target_pointer_width = "64")]
#[derive(PrimitiveEnum_i64, PartialEq, Debug, Clone, Copy)]
pub enum EnumI64 {
